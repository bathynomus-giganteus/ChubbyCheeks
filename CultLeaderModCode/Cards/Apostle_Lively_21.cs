...
public class Apostle_Lively_21 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/开核桃大师.png");

    public Apostle_Lively_21() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

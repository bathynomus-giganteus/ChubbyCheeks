...
public class Apostle_Lively_14 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/干净的话就没活干了.png");

    public Apostle_Lively_14() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Melancholy_13 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/有罪宣言.png");
    public Apostle_Melancholy_13() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

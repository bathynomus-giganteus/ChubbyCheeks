...
public class Apostle_Pure_24 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/铁锹击.png");

    public Apostle_Pure_24() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

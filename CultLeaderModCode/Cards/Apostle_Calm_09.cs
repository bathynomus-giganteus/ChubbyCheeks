...
public class Apostle_Calm_09 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/泳池候选地.png");

    public Apostle_Calm_09() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class PersonalitySelectCalmCard : ModCardTemplate
{
    ...
    public PersonalitySelectCalmCard() : base(0, CardType.Power, CardRarity.Event, TargetType.Self) { }

    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        var owner = base.Owner.Creature;
        var power = await PowerCmd.Apply<PersonalityCardFetchCalmPower>(choiceContext, owner, 1m, owner, this);

...
public class Apostle_Pure_05 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/最强的收集品.png");

    public Apostle_Pure_05() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

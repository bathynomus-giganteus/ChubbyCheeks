...
public class Apostle_Melancholy_04 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/内向人斩切.png");

    public Apostle_Melancholy_04() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Calm_19 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/墨水洗礼.png");

    public Apostle_Calm_19() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

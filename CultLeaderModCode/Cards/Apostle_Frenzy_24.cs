...
public class Apostle_Frenzy_24 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/篝火.png");

    public Apostle_Frenzy_24() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

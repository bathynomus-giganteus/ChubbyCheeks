...
public class Apostle_Pure_14 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/钻石穿刺.png");

    public Apostle_Pure_14() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

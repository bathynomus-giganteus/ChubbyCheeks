...
public class Apostle_Pure_25 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/pure_25.png");

    public Apostle_Pure_25() : base(0, CardType.Skill, CardRarity.Basic, TargetType.Self) { }

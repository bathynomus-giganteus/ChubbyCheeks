...
public class Apostle_Lively_01 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/呱呱雨.png");

    public Apostle_Lively_01() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

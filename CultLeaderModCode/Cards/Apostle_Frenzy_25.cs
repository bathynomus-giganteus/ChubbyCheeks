...
public class Apostle_Frenzy_25 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/手里剑要飞了.png");

    public Apostle_Frenzy_25() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

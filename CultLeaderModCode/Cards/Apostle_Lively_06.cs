...
public class Apostle_Lively_06 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/音速斩击.png");

    public Apostle_Lively_06() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

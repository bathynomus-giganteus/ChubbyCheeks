...
public class Apostle_Frenzy_12 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/被混沌勾引.png");

    public Apostle_Frenzy_12() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

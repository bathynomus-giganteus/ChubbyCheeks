...
public class Apostle_Pure_11 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/谢绝_Non_grata.png");

    public Apostle_Pure_11() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Frenzy_08 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/淬火击.png");

    public Apostle_Frenzy_08() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

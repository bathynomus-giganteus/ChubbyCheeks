...
public class Apostle_Lively_18 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/圣裁宣告.png");

    public Apostle_Lively_18() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

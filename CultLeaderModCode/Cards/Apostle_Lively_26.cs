...
public class Apostle_Lively_26 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/DX_炮弹.png");

    public Apostle_Lively_26() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

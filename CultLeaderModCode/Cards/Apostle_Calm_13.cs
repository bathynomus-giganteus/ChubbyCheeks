...
public class Apostle_Calm_13 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/雪雾.png");

    public Apostle_Calm_13() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

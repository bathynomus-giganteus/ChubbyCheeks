...
public class Apostle_Frenzy_02 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/真正的治愈.png");

    public Apostle_Frenzy_02() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

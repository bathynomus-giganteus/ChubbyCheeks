...
public class Apostle_Calm_07 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/锗玉电热毯.png");

    public Apostle_Calm_07() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

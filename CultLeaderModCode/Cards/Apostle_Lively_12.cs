...
public class Apostle_Lively_12 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/警戒线上的幽灵.png");

    public Apostle_Lively_12() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

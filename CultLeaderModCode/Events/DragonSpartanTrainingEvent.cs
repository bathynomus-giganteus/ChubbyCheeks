...
public class DragonSpartanTrainingEvent : CultLeaderModEventBase
{
    public override EventAssetProfile AssetProfile =>
        new(InitialPortraitPath: "res://CultLeaderMod/images/events/dragon_spartan_training.png");

    public override bool IsAllowed(IRunState runState) =>
        !HasSeenEvent(runState) &&
        HasEnoughPersonalityCards(runState, CultLeaderCardTags.Frenzy);
    ...
    {
        await RelicCmd.Obtain<SwooshGlovesRelic>(Owner!);

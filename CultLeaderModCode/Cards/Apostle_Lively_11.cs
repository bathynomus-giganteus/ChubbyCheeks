...
public class Apostle_Lively_11 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/堂堂正正的舞蹈对决.png");

    public Apostle_Lively_11() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

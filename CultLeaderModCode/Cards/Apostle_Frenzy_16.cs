...
public class Apostle_Frenzy_16 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/喜欢喝彩的演员.png");

    public Apostle_Frenzy_16() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

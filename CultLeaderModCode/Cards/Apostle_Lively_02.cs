...
public class Apostle_Lively_02 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/再来一次.png");

    public Apostle_Lively_02() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

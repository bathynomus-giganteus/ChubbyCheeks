...
public class Apostle_Melancholy_07 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/芬多精波动.png");
    public Apostle_Melancholy_07() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

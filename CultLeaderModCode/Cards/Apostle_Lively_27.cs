...
public class Apostle_Lively_27 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/噶哦哦.png");

    public Apostle_Lively_27() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

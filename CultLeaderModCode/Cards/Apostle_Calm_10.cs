...
public class Apostle_Calm_10 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/限定贴纸.png");

    public Apostle_Calm_10() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

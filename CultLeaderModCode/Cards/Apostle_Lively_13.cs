...
public class Apostle_Lively_13 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/调整.png");

    public Apostle_Lively_13() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

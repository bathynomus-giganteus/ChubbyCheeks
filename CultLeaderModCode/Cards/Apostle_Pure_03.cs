...
public class Apostle_Pure_03 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/围猎.png");

    public Apostle_Pure_03() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

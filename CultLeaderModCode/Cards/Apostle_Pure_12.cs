...
public class Apostle_Pure_12 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/接受水的洗礼吧.png");

    public Apostle_Pure_12() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

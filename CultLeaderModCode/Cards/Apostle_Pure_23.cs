...
public class Apostle_Pure_23 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/投降投降了啦.png");

    public Apostle_Pure_23() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

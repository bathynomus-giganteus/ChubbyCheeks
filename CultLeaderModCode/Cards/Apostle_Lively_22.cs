...
public class Apostle_Lively_22 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/幸福的bee.png");

    public Apostle_Lively_22() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

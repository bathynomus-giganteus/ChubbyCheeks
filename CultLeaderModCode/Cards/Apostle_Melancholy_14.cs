...
public class Apostle_Melancholy_14 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/非法豆奶.png");
    public Apostle_Melancholy_14() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

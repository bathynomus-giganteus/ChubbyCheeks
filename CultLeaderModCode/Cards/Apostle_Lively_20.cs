...
public class Apostle_Lively_20 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/魔道学者之路.png");

    public Apostle_Lively_20() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

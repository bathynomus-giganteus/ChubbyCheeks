...
public class Apostle_Frenzy_26 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/发射啊biu.png");

    public Apostle_Frenzy_26() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

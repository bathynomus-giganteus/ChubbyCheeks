...
public class Apostle_Calm_05 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/咿_呀_蜜瓜吖.png");

    public Apostle_Calm_05() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Lively_23 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/蜂蜜鱼_哈姆.png");

    public Apostle_Lively_23() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class PersonalityChoiceLivelyCard : ModCardTemplate
{
    ...
    public PersonalityChoiceLivelyCard() : base(0, CardType.Skill, CardRarity.Event, TargetType.Self, false) { }

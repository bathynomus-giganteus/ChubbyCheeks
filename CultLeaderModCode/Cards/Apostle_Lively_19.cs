...
public class Apostle_Lively_19 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/充满魄力的新秀.png");

    public Apostle_Lively_19() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Frenzy_05 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/Money_Gun.png");

    public Apostle_Frenzy_05() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Melancholy_03 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/土豆番薯.png");

    public Apostle_Melancholy_03() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

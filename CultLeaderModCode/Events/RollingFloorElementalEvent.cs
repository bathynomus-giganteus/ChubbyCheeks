...
public class RollingFloorElementalEvent : CultLeaderModEventBase
{
    public override EventAssetProfile AssetProfile =>
        new(InitialPortraitPath: "res://CultLeaderMod/images/events/rolling_floor_elemental.png");

    public override bool IsAllowed(IRunState runState) =>
        !HasSeenEvent(runState) &&
        HasEnoughPersonalityCards(runState, CultLeaderCardTags.Pure);
    ...
    {
        await RelicCmd.Obtain<NayaDolphinWaterGunRelic>(Owner!);

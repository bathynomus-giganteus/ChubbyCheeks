...
public class Apostle_Calm_18 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/蜂蜜炸弹.png");

    public Apostle_Calm_18() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

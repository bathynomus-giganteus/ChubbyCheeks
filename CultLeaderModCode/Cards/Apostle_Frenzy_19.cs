...
public class Apostle_Frenzy_19 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/向前迈进的决心.png");

    public Apostle_Frenzy_19() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Pure_04 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/休假中潜逃.png");

    public Apostle_Pure_04() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

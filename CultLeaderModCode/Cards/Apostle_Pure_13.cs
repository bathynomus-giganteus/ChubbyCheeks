...
public class Apostle_Pure_13 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/汁液泵机发射.png");

    public Apostle_Pure_13() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Pure_20 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/帮帮我朋友们.png");

    public Apostle_Pure_20() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Melancholy_01 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/软乎乎Time.png");

    public Apostle_Melancholy_01() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

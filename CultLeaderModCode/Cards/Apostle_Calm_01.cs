...
public class Apostle_Calm_01 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/雪花蝶舞.png");

    public Apostle_Calm_01() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

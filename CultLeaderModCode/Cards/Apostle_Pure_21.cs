...
public class Apostle_Pure_21 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/清晰的界限.png");

    public Apostle_Pure_21() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

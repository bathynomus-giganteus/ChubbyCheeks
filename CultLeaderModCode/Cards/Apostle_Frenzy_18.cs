...
public class Apostle_Frenzy_18 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/纯真光束.png");

    public Apostle_Frenzy_18() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

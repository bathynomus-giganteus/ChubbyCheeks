...
public class Apostle_Melancholy_10 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/炸猪排市长洛涅.png");
    public Apostle_Melancholy_10() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Lively_16 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/速邦配送.png");

    public Apostle_Lively_16() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

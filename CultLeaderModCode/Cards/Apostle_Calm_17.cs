...
public class Apostle_Calm_17 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/修剪枝条.png");

    public Apostle_Calm_17() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

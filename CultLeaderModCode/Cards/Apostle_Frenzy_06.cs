...
public class Apostle_Frenzy_06 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/猩红之雨.png");

    public Apostle_Frenzy_06() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

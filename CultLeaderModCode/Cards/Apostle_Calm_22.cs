...
public class Apostle_Calm_22 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/摇曳幽烛.png");

    public Apostle_Calm_22() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

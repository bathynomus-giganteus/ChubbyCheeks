...
public class Apostle_Calm_16 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/粉碎.png");

    public Apostle_Calm_16() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

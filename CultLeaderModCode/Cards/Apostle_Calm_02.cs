...
public class Apostle_Calm_02 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/百帕斯卡_挥棒.png");

    public Apostle_Calm_02() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

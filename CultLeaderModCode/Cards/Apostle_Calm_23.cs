...
public class Apostle_Calm_23 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/脑机连接开始.png");

    public Apostle_Calm_23() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Melancholy_11 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/强制起床装置.png");
    public Apostle_Melancholy_11() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Calm_06 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/刺痛的门卫.png");

    public Apostle_Calm_06() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

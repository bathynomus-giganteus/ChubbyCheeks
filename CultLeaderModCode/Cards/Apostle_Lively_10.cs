...
public class Apostle_Lively_10 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/总有一天会发生的事.png");

    public Apostle_Lively_10() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

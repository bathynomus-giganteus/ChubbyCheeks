...
public class Apostle_Lively_17 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/次元裂缝.png");

    public Apostle_Lively_17() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Frenzy_14 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/收款的时间到了.png");

    public Apostle_Frenzy_14() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

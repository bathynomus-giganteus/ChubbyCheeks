...
public class Apostle_Calm_14 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/新产品试用.png");

    public Apostle_Calm_14() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

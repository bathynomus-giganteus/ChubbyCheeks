...
public class Apostle_Melancholy_24 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/斧头会飞出去的.png");
    public Apostle_Melancholy_24() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

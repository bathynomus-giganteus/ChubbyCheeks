...
public class Apostle_Melancholy_22 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/猩红收割.png");
    public Apostle_Melancholy_22() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Pure_16 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/欧珀粉.png");

    public Apostle_Pure_16() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

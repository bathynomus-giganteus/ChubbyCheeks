...
public class Apostle_Frenzy_09 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/鹿派斩击.png");

    public Apostle_Frenzy_09() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

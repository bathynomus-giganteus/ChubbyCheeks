...
public class Apostle_Melancholy_02 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/魔_弹_射_手.png");

    public Apostle_Melancholy_02() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

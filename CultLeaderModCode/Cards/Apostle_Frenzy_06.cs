...
public class Apostle_Frenzy_06 : ModCardTemplate
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DynamicVar("VigorAmt", 6m)];
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<DimensionPositionPower>(choiceContext, owner, 1m, owner, this);
    }

    protected override void OnUpgrade()
    {
        DynamicVars["VigorAmt"].UpgradeValueBy(3m);
    }
}

...
public class Apostle_Calm_25 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/XG_激光.png");

    public Apostle_Calm_25() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Frenzy_21 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/古老的誓约.png");

    public Apostle_Frenzy_21() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

	...
	private static void Postfix(string language, Dictionary<string, LocTable> tables)
	{
		...
		if (tables.TryGetValue("cards", out var cardsTable))
		{
			cardsTable.MergeWith(new Dictionary<string, string>
			{
				...
				["CULT_LEADER_MOD_CARD_APOSTLE_LIVELY_01.description"] = "回合开始时，获得{RetainAmt:diff()}层保留，回复1点生命，持续7回合。",
				...
				["CULT_LEADER_MOD_CARD_APOSTLE_LIVELY_08.description"] = "从3张埃皮康卡牌中选择1张加入手牌。若当前保留与幸福合计不少于10层，则改为将3张全部加入手牌。",
				...
				["CULT_LEADER_MOD_CARD_APOSTLE_LIVELY_13.description"] = "每当你获得保留或幸福时，对随机敌人造成3点伤害，然后本场战斗中此伤害+3。",
				...
				["CULT_LEADER_MOD_CARD_APOSTLE_LIVELY_17.description"] = "造成{Damage:diff()}点伤害。若打出后手牌不少于{HandThreshold:diff()}张，眩晕目标。",
				...
				["CULT_LEADER_MOD_CARD_APOSTLE_MELANCHOLY_02.description"] = "移除最多{MaxPain:diff()}层苦痛施予，获得{IfUpgraded:show:2倍|等量}的魔弹，将一张“魔.弹.の.射.手”加入抽牌堆。",
				["CULT_LEADER_MOD_CARD_APOSTLE_MELANCHOLY_02_1.title"] = "魔.弹.の.射.手",
				["CULT_LEADER_MOD_CARD_APOSTLE_MELANCHOLY_02_1.description"] = "造成{Damage:diff()}点伤害{Hits:diff()}次。\n打出后若仍有魔弹，将此牌置于抽牌堆顶；否则将本牌送入消耗堆，并将一张“终.末.の.爆.炸”加入抽牌堆。",
				...
				["CULT_LEADER_MOD_CARD_APOSTLE_MELANCHOLY_15.description"] = "对全体敌人造成{Damage:diff()}点伤害；本场战斗中每向敌人施加过一次负面效果，伤害额外+{BonusPerDebuff:diff()}点。",
				["CULT_LEADER_MOD_CARD_APOSTLE_MELANCHOLY_16.title"] = "堕落玫瑰",
				["CULT_LEADER_MOD_CARD_APOSTLE_MELANCHOLY_16.description"] = "选择并移除抽牌堆中最多{Cards:diff()}张牌，获得等同于其费用之和的苦痛施予。{IfUpgraded:show:\n额外获得{PainBonus:diff()}层苦痛施予。|}",
				...
				["CULT_LEADER_MOD_CARD_APOSTLE_MELANCHOLY_22.description"] = "对所有敌人造成{Damage:diff()}点伤害，然后移除其所有减益效果；每移除{StackThreshold:diff()}层减益，抽1张牌（最多抽{MaxDraw:diff()}张）。",
		...
		if (tables.TryGetValue("powers", out var powersTable))
		{
			powersTable.MergeWith(new Dictionary<string, string>
			{
				...
				["CULT_LEADER_MOD_POWER_ADJUST_POWER.description"] = "每当你获得保留或幸福时，对随机敌人造成伤害，随后本场战斗中此伤害+3。",
		...
		if (tables.TryGetValue("relics", out var relicsTable))
		{
			relicsTable.MergeWith(new Dictionary<string, string>
			{
				...
				["CULT_LEADER_MOD_RELIC_SHEDI_DIMENSION_SCYTHE_RELIC.description"] = "每经过三场非boss战斗，下一次移动可以无视地图路线。",
				...
				["CULT_LEADER_MOD_RELIC_MAGIC_BATTERY_RELIC.description"] = "每使用20能量点，对所有敌人造成10点伤害。",
				...
				["CULT_LEADER_MOD_RELIC_DRAGON_LIGHT_SWORD_RELIC.description"] = "同一场战斗中每打出15张活泼使徒牌，获得1保留，每场战斗后获得保留所需使徒牌数量-1（最低为5）。",
				["CULT_LEADER_MOD_RELIC_DRAGON_LIGHT_SWORD_RELIC.flavor"] = "这是一把惊人的剑，用的越多就会变得越强",
				["CULT_LEADER_MOD_RELIC_EMILIAS_EPAD_CLASSIC_RELIC.title"] = "艾蜜莉雅的E-pad经典款",
				["CULT_LEADER_MOD_RELIC_EMILIAS_EPAD_CLASSIC_RELIC.description"] = "敌人回合开始时你获得1覆甲，你的卡组里每有10张冷静使徒牌，便可以多获得1点。",
				["CULT_LEADER_MOD_RELIC_EMILIAS_EPAD_CLASSIC_RELIC.flavor"] = "艾蜜莉雅总是拿在手上的平板。随时都能获得艾蜜莉雅需要的信息，并拥有超大的容量空间。",
		...
		if (tables.TryGetValue("events", out var eventsTable))
		{
			eventsTable.MergeWith(new Dictionary<string, string>
			{
				...
				["CULT_LEADER_MOD_EVENT_MYSTERIOUS_CONVENIENCE_CLERK_EVENT.pages.ACCEPT.description"] = "你是在拗不过幽灵的盛情邀请，约定今晚10点在ForsterNova西边的后巷集合，她给了你一件披风，说是接头的时候要穿着它才不引人注目，这对么？",
				...
				["CULT_LEADER_MOD_EVENT_FAIRY_SURVEILLANCE_REQUEST_EVENT.pages.INITIAL.options.ACCEPT.description"] = "获得艾蜜莉雅的E-pad经典款",
				...
				["CULT_LEADER_MOD_EVENT_FORTUNE_TELLER_CAT_CUSHION_EVENT.pages.PERSONALITY.options.PURE.description"] = "获得 性格卡牌【纯粹】",
				["CULT_LEADER_MOD_EVENT_FORTUNE_TELLER_CAT_CUSHION_EVENT.pages.PERSONALITY.options.FRENZY.title"] = "愤怒的去寻找弄断桥的人（愤怒）",
				["CULT_LEADER_MOD_EVENT_FORTUNE_TELLER_CAT_CUSHION_EVENT.pages.PERSONALITY.options.FRENZY.description"] = "获得 性格卡牌【狂热】",
				["CULT_LEADER_MOD_EVENT_FORTUNE_TELLER_CAT_CUSHION_EVENT.pages.PERSONALITY.options.CALM.title"] = "沉着的分析有什么过河的替代方案（沉着）",
				["CULT_LEADER_MOD_EVENT_FORTUNE_TELLER_CAT_CUSHION_EVENT.pages.PERSONALITY.options.CALM.description"] = "获得 性格卡牌【冷静】",
				["CULT_LEADER_MOD_EVENT_FORTUNE_TELLER_CAT_CUSHION_EVENT.pages.PERSONALITY.options.MELANCHOLY.title"] = "忧愁的叹息自己过不了河了（忧愁）",
				["CULT_LEADER_MOD_EVENT_FORTUNE_TELLER_CAT_CUSHION_EVENT.pages.PERSONALITY.options.MELANCHOLY.description"] = "获得 性格卡牌【忧郁】",
				["CULT_LEADER_MOD_EVENT_FORTUNE_TELLER_CAT_CUSHION_EVENT.pages.PERSONALITY.options.LIVELY.title"] = "乐观的表示桥断了重建就好了（乐观）",
				["CULT_LEADER_MOD_EVENT_FORTUNE_TELLER_CAT_CUSHION_EVENT.pages.PERSONALITY.options.LIVELY.description"] = "获得 性格卡牌【活泼】",

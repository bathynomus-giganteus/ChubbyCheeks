...
public class Apostle_Frenzy_17 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/潜入采访中.png");

    public Apostle_Frenzy_17() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

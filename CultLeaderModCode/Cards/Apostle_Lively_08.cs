...
public class Apostle_Lively_08 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/戏剧性演出.png");

    public Apostle_Lively_08() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

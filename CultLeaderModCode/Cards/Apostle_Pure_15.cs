...
public class Apostle_Pure_15 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/pure/快躲开啊啊_噫.png");

    public Apostle_Pure_15() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

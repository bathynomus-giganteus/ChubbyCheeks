...
public class Apostle_Calm_21 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/超天才的演出.png");

    public Apostle_Calm_21() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

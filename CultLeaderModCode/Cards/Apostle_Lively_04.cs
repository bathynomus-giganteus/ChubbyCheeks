...
public class Apostle_Lively_04 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/强力一击.png");

    public Apostle_Lively_04() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

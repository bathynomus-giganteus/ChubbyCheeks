...
public class FairySurveillanceRequestEvent : CultLeaderModEventBase
{
    public override EventAssetProfile AssetProfile =>
        new(InitialPortraitPath: "res://CultLeaderMod/images/events/fairy_surveillance.png");

    public override bool IsAllowed(IRunState runState) =>
        !HasSeenEvent(runState) &&
        HasEnoughPersonalityCards(runState, CultLeaderCardTags.Calm);
    ...
    {
        await RelicCmd.Obtain<EmiliasEpadClassicRelic>(Owner!);

    ...
    private static void Postfix(string language, Dictionary<string, LocTable> tables)
    {
        ...
        if (tables.TryGetValue("cards", out var cardsTable))
        {
            cardsTable.MergeWith(new Dictionary<string, string>
            {
                ...
                ["CULT_LEADER_MOD_CARD_APOSTLE_PURE_03.description"] = "造成10点伤害，重复3次。",
                ...
                ["CULT_LEADER_MOD_CARD_APOSTLE_PURE_05.description"] = "造成10点伤害。升级后15点。",
                ...
                ["CULT_LEADER_MOD_CARD_APOSTLE_PURE_24.description"] = "造成最大生命值20%的伤害\n升级：升级后20%变为25%",
                ["CULT_LEADER_MOD_CARD_APOSTLE_PURE_25.title"] = "黄瓜油",
                ["CULT_LEADER_MOD_CARD_APOSTLE_PURE_25.description"] = "获得2点再生\n升级：升级后添加：抽一张牌",

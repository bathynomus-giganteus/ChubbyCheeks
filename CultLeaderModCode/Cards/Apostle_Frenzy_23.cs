...
public class Apostle_Frenzy_23 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/那个收藏品是我的.png");

    public Apostle_Frenzy_23() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

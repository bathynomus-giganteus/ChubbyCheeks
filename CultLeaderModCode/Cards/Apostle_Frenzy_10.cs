...
public class Apostle_Frenzy_10 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/偏向性解说.png");

    public Apostle_Frenzy_10() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

...
public class Apostle_Melancholy_09 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/魔力喷发.png");
    public Apostle_Melancholy_09() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

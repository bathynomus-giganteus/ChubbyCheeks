...
{
    //Loads from CultLeaderMod/images/powers/your_power.png
    ...
    /// <summary>Called after the owner creature is healed. Override in subclasses to react to healing.</summary>
    public virtual Task AfterHeal(PlayerChoiceContext ctx, decimal amount) => Task.CompletedTask;
}

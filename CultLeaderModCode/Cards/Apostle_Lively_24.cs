...
public class Apostle_Lively_24 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/lively/炸弹来啦.png");

    public Apostle_Lively_24() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

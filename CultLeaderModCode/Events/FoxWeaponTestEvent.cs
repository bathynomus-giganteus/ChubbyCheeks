...
public class FoxWeaponTestEvent : CultLeaderModEventBase
{
    public override EventAssetProfile AssetProfile =>
        new(InitialPortraitPath: "res://CultLeaderMod/images/events/fox_weapon_test.png");

    public override bool IsAllowed(IRunState runState) =>
        !HasSeenEvent(runState) &&
        HasEnoughPersonalityCards(runState, CultLeaderCardTags.Lively);
    ...
    {
        await RelicCmd.Obtain<DragonLightSwordRelic>(Owner!);

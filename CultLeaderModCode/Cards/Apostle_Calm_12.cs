...
public class Apostle_Calm_12 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/calm/说闲话的玩偶.png");

    public Apostle_Calm_12() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

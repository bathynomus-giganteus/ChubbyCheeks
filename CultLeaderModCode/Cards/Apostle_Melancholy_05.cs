...
public class Apostle_Melancholy_05 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/melancholy/侧斩.png");

    public Apostle_Melancholy_05() : base(0, CardType.Skill, CardRarity.Common, TargetType.Self) { }

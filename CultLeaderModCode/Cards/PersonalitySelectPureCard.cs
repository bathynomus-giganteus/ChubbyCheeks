...
public class PersonalitySelectPureCard : ModCardTemplate
{
    ...
    public PersonalitySelectPureCard() : base(0, CardType.Power, CardRarity.Event, TargetType.Self) { }

    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        var owner = base.Owner.Creature;
        var power = await PowerCmd.Apply<PersonalityCardFetchPurePower>(choiceContext, owner, 1m, owner, this);

...
public class Apostle_Frenzy_07 : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(PortraitPath: "res://CultLeaderMod/images/card_portraits/frenzy/阿卡那.png");

    public Apostle_Frenzy_07() : base(0, CardType.Skill, CardRarity.Basic, TargetType.Self) { }
